...
Característica: Proceso de agendamiento de servicios
  ...
  Esquema del escenario: Crear una orden de servicio desde el call center
    Dado que en el call center se desea crear una orden de servicio con los siguientes datos
      | Tipo Identificacion | Identificacion   | Codigo cliente  | Nombre   | Correo electronico | Celular   |
      | <TipoID>            | <Identificacion> | <CodigoCliente> | <Nombre> | <Email>            | <Celular> |
    ...
    Ejemplos:
      | TipoID               | Identificacion | CodigoCliente | Nombre     | Email            | Celular    | CodigoServicio | ClaseServicio | TipoServicio | Prioridad | HoraInicio | HoraFin | Zonas  | Observacion        | Serial  | Productos  | Falla   |
      | Cedula de ciudadanía | 1012848484     | CC-123        | Juan Perez | juan@example.com | 1234567890 | SERV-001       | Clase A       | Tipo A       | Alta      | 09:00      | 13:00   | Zona 1 | Servicio de prueba | 1234567 | Producto X | Falla Y |
