...
Característica: Proceso de agendamiento de servicios
  ...
  Esquema del escenario: Crear una orden de servicio desde el call center
    ...
    Ejemplos:
      ...
      | Cedula de ciudadanía | 1012835810     | CC-123        | Juan Perez | juan@example.com | 1234567890 | SERV-001       | Clase A       | Tipo A       | Alta      | 09:00      | 13:00   | Zona 1 | Servicio de prueba | 1234567 | Producto X | Falla Y | Cl. 118 #19-52 | Usaquén, Bogotá |
